...
本文的后续结构如下, 第二部分将阐述本工作的整体架构, 包括前端, 后端以及AI交互的逻辑, 并对全部功能进行介绍; 部署和调试本工作相关源码的实验部分将在第三部分展开叙述; 第四部分阐述本工作的局限性以及未来发展远景.
...
显然, 我以整活的方式撰写了这个README.md, 里面有诸多表述不清晰的地方, 因此, 请不要着急攻击, 因为开源这个项目距离我完成编写以及过去了数月, 很多东西我都不记得了, 在编写这个README时, 我不得不重新翻阅难以阅读的源码, 并补上一些注释
